...
<div class="todo_form">
    ...
    <div class="heading"><p>
        <h3>Enter New Working Schedule</h3></P></div>
    ...
    <f:form action="${url_add_task}" modelAttribute="command">
        ...
        <div class="title">
            <p>
            <h3>Give a Title For Your Task</h3></p>
        ...
        <div class="textarea">
            <p>
            <h3>Give a Description For Your Task</h3></p>
        ...
        <div class="priority">
            <p>
            <h3>Select The Priority of Your Task</h3></p>
        </div>
        <div class="radio">
